      ...
      return array(
        ...
        'fields' => array(
          array(
            ...
            'tags' => 'name="ldap_login_hostname_field" id="ldap_login_hostname_field"',
          ),
          ...
          array(
            ...
            'tags' => 'name="ldap_login_port_field" id="ldap_login_port_field"',
          ),
          ...
          array(
            ...
            'tags' => 'name="ldap_login_port_field" id="ldap_login_filter_field"',
          ),
          ...
          array(
            ...
            'tags' => 'name="ldap_login_port_field" id="ldap_login_fname_field"',
          ),
          ...
          array(
            ...
            'tags' => 'name="ldap_login_port_field" id="ldap_login_sname_field"',
          ),
          ...
          array(
            ...
            'tags' => 'name="ldap_login_port_field" id="ldap_login_mail_field"',
          ),
          ...
          array(
            ...
            'label' => 'Generic LDAP search strings (at login the plugin will replace USERNAME with the user\'s username separate with \'/\')',
            'type' => 'text',
